...
const backgrounds = [
  { name: "Grid Pattern", component: Hero, description: "Grille moderne et professionnelle avec animations subtiles" },
  { name: "Aurora", component: HeroWithAurora, description: "Effet d'aurore boréale premium et élégant" },
  { name: "Retro Grid", component: HeroWithRetroGrid, description: "Grille 3D style cyberpunk futuriste" },
]

export default function BackgroundsDemo() {
  const [currentBg, setCurrentBg] = useState(0)
  const CurrentComponent = backgrounds[currentBg].component
